...
public class Control
{
    ...
    private String preload_resources;
    ...
    public int getScreenshot_icon_state(){
        return this.screenshot_icon_state;
    }
    ...
    public int getUpload_picture_icon_state(){
        return this.upload_picture_icon_state;
    }
    ...
    public String getAnswer_guide_icon_url(){
        return this.answer_guide_icon_url;
    }
    ...
    public String getAnswer_guide_ios_url(){
        return this.answer_guide_ios_url;
    }
    ...
    public String getAnswer_guide_android_url(){
        return this.answer_guide_android_url;
    }
    ...
    public boolean getEnable_cm_biz_helper(){
        return this.enable_cm_biz_helper;
    }
    public void setPreload_resources(String preload_resources){
        this.preload_resources = preload_resources;
    }
    public String getPreload_resources(){
